...
class WebConsoleStaticTests(unittest.TestCase):
    ...
    def test_styles_lock_direction_a_shell_geometry(self) -> None:
        required_tokens = [
            ...
            '--sans: "Inter"',
            ".app-shell",
            "grid-template-rows: minmax(var(--topbar-h), auto)",
            ".topbar",
            ".topbar__identity",
            ".topbar__identity-head",
            ".topbar__identity-title",
            ".topbar__identity-grid",
            ".topbar__identity-chip",
            ".topbar__identity .status-chip__label",
            ".topbar__identity .status-chip__meta",
            ".sidebar",
            ".main",
            ".overlay",
            ".locale-switch",
            ...
            ".experience-section__meta",
            ".experience-section__body",
            ".experience-item",
            ".experience-item__head",
            ".experience-item__lead",
            ".experience-item__chips",
            ".experience-item__meta",
            ".experience-item__evidence",
            ".experience-item__evidence-label",
            ".experience-empty",
            ".history-report",
            ".history-table__head",
            ".history-table__row",
            ...
            ".history-compare__select",
            ".history-compare__value",
            ...
            ".notification-feed__group",
            ".notification-feed__group-head",
            ".notification-feed__item--read",
            ".notification-feed__item--unread",
            ".notification-feed__item--severity-error",
            ".notification-feed__details",
            ".notification-feed__links",
            ".notification-feed__read-toggle",
            ".mobile-workflow",
    ...
    def test_locale_persistence_and_bilingual_dashboard_config_palette_copy(self) -> None:
        ...
        copy_tokens = [
            ...
            "t('identity.port')",
            "t('identity.mode')",
            "t('identity.runnerControl')",
            "t('identity.redaction')",
            "t('palette.title')",
    ...
    def test_required_views_have_nonblank_render_content(self) -> None:
        render_markers = {
            ...
            "renderPrQueue": [
                "PR Queue",
                "Local PR packet review and guarded decisions",
                "data-pr-queue-select",
                "data-pr-queue-action",
                "Packet detail",
                "QA notes",
                "Validation logs",
                "Merge preflight",
                "Blocking reasons",
                "Dependency detail",
                "Validate, approve merge, discard, and request rebase require runner controls.",
                "/api/pr-queue/validate",
                "/api/pr-queue/discard",
                "/api/pr-queue/rebase",
                "renderWorktreeDiffFile(file)",
                "/api/pr-queue/",
            ],
            "renderGoals": [
                "Goal progress",
            ...
            "renderPrompts": ["Prompt inventory", "Inventory previews stay redacted. Select a prompt to open the explicit full-content read path.", "LAN safety keeps prompt previews redacted and blocks full prompt reads.", "Prompt editor", "Loaded through the explicit read path", "Resolved path", "FULL READ PREVIEW", "Filename validation", "Content validation", "Template-variable validation", "Save creates a backup first", "restore uses the selected backup", "Local diff preview", "No local content changes yet."],
            "renderHistory": [
                "Run history",
                "No run history yet.",
                "Selected run",
                ...
                "Validation gaps",
                "Merge blockers",
                "Safe read-only summary; raw logs, prompts, and diffs stay hidden.",
                "Split required",
            ...
            "renderNotifications": [
                ...
                "currentLiveRunNotifications(liveRun)",
                "currentLiveRunRunnerControl(liveRun)",
                "data-notification-read-filter",
                "data-notification-severity-filter",
                "data-notification-read-toggle",
                "data-notification-link",
                "renderNotificationSeverityGroup",
