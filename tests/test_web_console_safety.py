...
""",
    ...
    def test_lan_snapshot_redacts_sensitive_surfaces(self) -> None:
        ...
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["repo"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["run_dir"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["current_event"]["config_path"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["current_event"]["repo"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["current_event"]["run_dir"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["history"][0]["config_path"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["history"][0]["repo"])
        self.assertEqual("[redacted]", status_payload["runner_control"]["status"]["history"][0]["run_dir"])
        ...
        self.assertEqual("[redacted]", progress_payload["runner_control"]["status"]["repo"])
        self.assertEqual("[redacted]", progress_payload["runner_control"]["status"]["run_dir"])
        ...
        self.assertEqual("[redacted]", runner_status["status"]["repo"])
        self.assertEqual("[redacted]", runner_status["status"]["run_dir"])
    ...
    def test_lan_runner_control_responses_redact_runner_args(self) -> None:
        ...
        self.assertEqual("[redacted]", payload["runner_control"]["status"]["repo"])
        self.assertEqual("[redacted]", payload["runner_control"]["status"]["run_dir"])
        ...
        self.assertEqual("[redacted]", payload["snapshot"]["runner_control"]["status"]["repo"])
        self.assertEqual("[redacted]", payload["snapshot"]["runner_control"]["status"]["run_dir"])
