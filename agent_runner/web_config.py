...
CONFIG_CONTRACT_FIELDS: list[dict[str, Any]] = [
    ...
    *CODEX_MODEL_FIELD_SPECS,
    ...
    {"path": "claudecode_can_use_tool_strict_isolation", "group": "claude", "kind": "bool", "label": "Strict isolation", "restart": True, "allow_empty": True, "desc": "Deny Dev edits outside the selected task file set.", "hint": "Only enforced when dynamic permission is enabled."},
