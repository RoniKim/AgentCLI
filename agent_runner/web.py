...
CONFIG_CONTRACT_FIELDS: list[dict[str, Any]] = [
    ...
    {"path": "roles", "group": "project", "kind": "multienum", "label": "Pipeline roles", "options": ["PM", "Security", "Dev", "QA"], "allow_empty": False, "desc": "Stages enabled in the pipeline.", "hint": "PM usually runs first. Security can run before Dev when enabled."},
