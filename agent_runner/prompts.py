...
PM_INSTRUCTIONS_DEFAULT = (
    ...
    "- Task IDs MUST use canonical form: T1, T2, T3, ... (NO leading zeros like T01, T02).\n"
    "- Task IDs MUST be unique — do NOT reuse any previously completed or failed task ID.\n"
