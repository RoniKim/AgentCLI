...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--active-goal-update", action="store_true", default=None, help="Update the existing repo-local active goal using the provided active-goal fields")
    ...
    p.add_argument("--active-goal-notes", default=None, help="Operator notes to attach when updating an active goal")
